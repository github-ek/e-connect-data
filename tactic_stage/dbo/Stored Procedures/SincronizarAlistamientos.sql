...
BEGIN TRY
    ...
    BEGIN
        ...
        FROM [57DBWMS05].[eHistoricos].dbo.integraciones_actualizaciones a
        WHERE   
            a.id_integracion_actualizacion IN 
        (
            SELECT TOP (10000)
                id_integracion_actualizacion
            FROM [57DBWMS05].[eHistoricos].dbo.integraciones_actualizaciones
            WHERE   
        ...
        SELECT
            ...
            ,a.moddte
        INTO #source_ord
        FROM [57DBWMS05].[ttcwmsprdnew].dbo.ord a
        INNER JOIN [57DBWMS05].[eHistoricos].dbo.integraciones_actualizaciones z ON
            a.client_id = z.arg0
        AND a.ordnum = z.arg1
        AND a.wh_id = z.arg2
        WHERE   
        ...
        FROM [57DBWMS05].[ttcwmsprdnew].dbo.ord_line a
        INNER JOIN [57DBWMS05].[eHistoricos].dbo.integraciones_actualizaciones z ON
            a.client_id = z.arg0
        AND a.ordnum = z.arg1
        AND a.wh_id = z.arg2
        ...
        SELECT
            ...
            ,a.can_usr_id
        INTO #source_canpck
        FROM [57DBWMS05].[ttcwmsprdnew].dbo.canpck a
        INNER JOIN [57DBWMS05].[eHistoricos].dbo.causales_cancelacion_alistamientos b ON
            b.cancod = a.cancod
        INNER JOIN [57DBWMS05].[eHistoricos].dbo.integraciones_actualizaciones z ON
            a.client_id = z.arg0
        AND a.ordnum = z.arg1
    ...
    BEGIN
        ...
        BEGIN
            ...
            SET a.id_solicitud = b.id_solicitud
            FROM #alistamientos a
            INNER JOIN tactic_stage.dbo.solicitudes b ON
                b.id_cliente = a.id_cliente
            AND b.numero_orden = a.ordnum
            WHERE
                a.existe = 0
