...
BEGIN TRY
    ...
    BEGIN
        ...
        WHERE 1 = 1
        AND a.tipo_solicitud LIKE 'MANUFACTURA%'
        ...
        INNER JOIN [$(eConnect)].dbo.lineas_negocio d ON
            d.nombre = 'MAQUILA'
        ...
        IF OBJECT_ID('tempdb..#ordenes_lineas_bom') IS NOT NULL BEGIN
            DROP TABLE #ordenes_lineas_bom
        END
        ...
        SELECT
            ...
            ,b.lote
        INTO #ordenes_lineas_bom
        FROM #ordenes a
        INNER JOIN [$(eConnect)].dbo.solicitudes_lineas_bom b ON
            b.id_solicitud = a.id_solicitud
    ...
    BEGIN
        ...
        INSERT INTO [$(eConnect)].dbo.ordenes_manufactura
            (tipo_orden
            ,numero_orden
            ,estado
            ,id_linea_negocio
        ...
        INSERT INTO [$(eConnect)].dbo.ordenes_manufactura_lineas
        ...
        INSERT INTO [$(eConnect)].dbo.ordenes_manufactura_lineas_bom
            (id_orden_manufactura
            ,numero_suborden
            ,numero_linea
        ...
        SELECT
            ...
            ,a.fecha_modificacion
        FROM #ordenes a
        INNER JOIN #ordenes_lineas_bom b ON
            b.id = a.id
    END
