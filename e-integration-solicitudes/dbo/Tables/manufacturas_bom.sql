CREATE TABLE [dbo].[manufacturas_bom] (
    ...
    [producto_bom_codigo_alterno]             VARCHAR (50)    NOT NULL,
    [cantidad_bom]                            DECIMAL (19, 4) NOT NULL,
    ...
    [id_producto_bom]                         BIGINT          NULL,
    [id_estado_inventario_bom]                VARCHAR (4)     NULL,
    [id_subestado_inventario_bom]             VARCHAR (4)     NULL,
    [version]                                 INT             NOT NULL,
    [fecha_creacion]                          DATETIME2 (0)   NOT NULL,
    [usuario_creacion]                        VARCHAR (50)    NOT NULL,
    [fecha_modificacion]                      DATETIME2 (0)   NOT NULL,
    [usuario_modificacion]                    VARCHAR (50)    NOT NULL,
    CONSTRAINT [PK_manufacturas_bom] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 80)
);
