...
BEGIN TRY
    ...
    BEGIN
        ...
        SELECT
            ...
            ,a.id_tercero
            ,a.tercero_codigo_alterno AS tercero_identificacion
            ,a.tercero_nombre
            ,a.id_canal
            ,a.canal_codigo_alterno

            ,a.id_ciudad AS id_ciudad_destinatario
            ,a.ciudad_codigo_alterno AS ciudad_destinatario_codigo_alterno
            ,a.direccion AS direccion_destinatario
            ,CAST(NULL AS BIGINT) AS id_direccion_destinatario
            ,CAST(NULL AS BIGINT) AS id_punto_destinatario
            ,a.punto_codigo_alterno AS punto_destinatario_codigo_alterno
            ,a.punto_nombre AS punto_destinatario_nombre
            ,a.requiere_agendamiento AS requiere_cita_destinatario

            ,a.femi AS fecha_minima_solicitada
            ,a.fema AS fecha_maxima_solicitada
            ,a.homi AS hora_minima_solicitada
            ,a.homa AS hora_maxima_solicitada
        ...
        SELECT
            ...
            ,a.ciudad_destinatario_codigo_alterno
            ,a.direccion_destinatario
            ,a.id_direccion_destinatario
            ,a.id_punto_destinatario
            ,a.punto_destinatario_codigo_alterno
            ,a.punto_destinatario_nombre
            ,a.requiere_cita_destinatario
            ,a.fecha_maxima_solicitada AS fecha_cita_destinatario
            ,a.hora_minima_solicitada AS hora_cita_minima_destinatario
            ,a.hora_minima_solicitada AS hora_cita_maxima_destinatario
