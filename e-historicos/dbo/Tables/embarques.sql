CREATE TABLE [dbo].[embarques] (
    ...
    CONSTRAINT [PK_embarques] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [UK_embarques_01] UNIQUE NONCLUSTERED ([ship_id] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [UK_embarques_02] UNIQUE NONCLUSTERED ([record_key] ASC) WITH (FILLFACTOR = 80)
);
