CREATE TABLE [dbo].[ordenes_salida] (
    ...
    CONSTRAINT [PK_ordenes_salida] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [UK_ordenes_salida_01] UNIQUE NONCLUSTERED ([client_id] ASC, [wh_id] ASC, [ordnum] ASC, [ordlin] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [UK_ordenes_salida_02] UNIQUE NONCLUSTERED ([record_key] ASC, [line_key] ASC) WITH (FILLFACTOR = 80)
);
