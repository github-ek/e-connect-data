CREATE TABLE [dbo].[productos_codigos] (
    ...
    CONSTRAINT [PK_productos_codigos] PRIMARY KEY CLUSTERED ([id] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [UK_productos_codigos_01] UNIQUE NONCLUSTERED ([prt_client_id] ASC, [prtnum] ASC, [alt_prtnum] ASC, [alt_prt_typ] ASC) WITH (FILLFACTOR = 80)
);
