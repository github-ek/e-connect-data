...
(
    ...
    CONSTRAINT [PK_embarques_lineas] PRIMARY KEY CLUSTERED ([id] ASC) ON [PRIMARY],
    CONSTRAINT [UK_embarques_lineas_01] UNIQUE NONCLUSTERED ([ship_id] ASC, [ship_line_id] ASC, [dtlnum] ASC) ON [PRIMARY],
    CONSTRAINT [UK_embarques_lineas_02] UNIQUE NONCLUSTERED ([record_key] ASC, [dtlnum] ASC) ON [PRIMARY]
) ON [PRIMARY]