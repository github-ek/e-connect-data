CREATE TABLE [dbo].[mensajes_recibo_jda_lineas] (
    ...
    CONSTRAINT [PK_mensajes_recibo_jda_lineas] PRIMARY KEY CLUSTERED ([id_mensaje], [numero_linea]),
    CONSTRAINT [FK_mensajes_recibo_jda_lineas_mensajes_recibo_jda] FOREIGN KEY ([id_mensaje]) REFERENCES [mensajes_recibo_jda]([id_mensaje]), 
);
