CREATE PROCEDURE [dbo].[MergeMaestroTiposPromesaEntregaFromProduction2Test] AS
BEGIN
    BEGIN TRY
        BEGIN TRANSACTION

        BEGIN
            MERGE [$(eConnect)].dbo.tipos_promesa_entrega AS t
            USING [$(SERVER_MASTER_DATA)].[$(eConnectMasterData)].dbo.tipos_promesa_entrega AS s ON 
                s.id_promesa_entrega = t.id_promesa_entrega
