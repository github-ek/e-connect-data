CREATE TABLE [dbo].[solicitudes] (
    ...
    [tercero_identificacion]       VARCHAR (20)  DEFAULT ('') NOT NULL,
    [tercero_nombre]               VARCHAR (100) DEFAULT ('') NOT NULL,
    [id_canal]                     BIGINT        NULL,
    [canal_codigo_alterno]         VARCHAR (50)  DEFAULT ('') NOT NULL,
    ...
    [nota]                         VARCHAR (200) DEFAULT ('') NOT NULL,
    [numero_solicitud_anulado]     VARCHAR (20)  DEFAULT ('') NOT NULL,
    [id_causal_anulacion]          BIGINT        NULL,
    [nota_anulacion]               VARCHAR (200) DEFAULT ('') NOT NULL,
    [usuario_anulacion]            VARCHAR (50)  DEFAULT ('') NOT NULL,
